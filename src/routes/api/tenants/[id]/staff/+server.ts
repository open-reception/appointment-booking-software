          ...
          schema: {
            ...
            items: {
              ...
              properties: {
                ...
                role: { type: "string", enum: ["GLOBAL_ADMIN", "TENANT_ADMIN", "STAFF"], description: "User role" },
                isActive: { type: "boolean", description: "Whether user is active (can be null)" },
                confirmationState: { type: "string", enum: ["INVITED", "CONFIRMED", "ACCESS_GRANTED"], description: "User confirmation state (can be null)" },
                createdAt: { type: "string", format: "date-time", description: "Creation timestamp (can be null)" },
                updatedAt: { type: "string", format: "date-time", description: "Last update timestamp (can be null)" },
                lastLoginAt: { type: "string", format: "date-time", description: "Last login timestamp (can be null)" },
              },
