...
registerOpenAPIRoute("/tenants/{id}/schedule", "GET", {
  summary: "Get tenant schedule",
  description:
    "Retrieves the appointment schedule for a specific tenant within a date range. Shows available time slots, existing appointments, and agent availability. This is a public endpoint that doesn't require authentication.",
  tags: ["Schedule", "Public"],
  parameters: [
    {
      name: "id",
      in: "path",
                ...
                items: {
                  ...
                  properties: {
                    ...
                    channels: {
                      type: "object",
                      description:
                        "Schedule data organized by channel ID (key-value pairs where key is channel UUID and value contains channel info, appointments, and available slots)",
                    },
                  },
                },
