<script lang="ts">
  ...
  import { EditChannelFormPublicBooking } from "../../(components)/edit-channel-form";
...
<SidebarLayout
  breakcrumbs={[
    ...
    {
      label: m["channels.edit.publicBooking.title"](),
